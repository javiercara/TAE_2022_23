...
```{r}
predict(m1, newdata = data.frame(Class = c("Crew", "First", "Second", "Third")), type = "response")
```
...
Para mujeres de tercera clase, por ekemplo, F = 0, S = 0, T = 1, M = 1. Por tanto el modelo es:
...
$$
se(\hat \beta_3 + \hat \beta_7) = \sqrt{V_{44} + V_{88} + 2V_{48}} \\
V = Var(\hat \beta)
$$
