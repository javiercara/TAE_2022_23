...
6. Extensiones del modelo lineal
    ...
    d. [Regresión local](lm_extensiones_regresionLocal.html) [(pdf)](lm_extensiones_regresionLocal.pdf)
...
9. Apéndices
    ...
    d. [Introducción a la simulación de variables aleatorias](apendice_simulacion.html) [(pdf)](apendice_simulacion.pdf)
